"""
Django settings for examserver project.
...
SECRET_KEY = os.environ['appv1']

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.getenv('appv2', 'False') == 'True'
...
WSGI_APPLICATION = 'examserver.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ['appv3'],
        'USER': os.environ['appv4'],
        'PASSWORD': os.environ['appv5'],
        'HOST': os.environ['appv6']
    }
}
